...
public class GlTextureFrameBuffer {
  ...
  public GlTextureFrameBuffer(int pixelFormat) {
    ...
    textureId = OpenglCommon.generateTexture(GLES20.GL_TEXTURE_2D);
    this.width = 0;
    this.height = 0;
    ...
    OpenglCommon.checkNoGLES2Error("Generate framebuffer");

    // Attach the texture to the framebuffer as color attachment.
    GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0,
        GLES20.GL_TEXTURE_2D, textureId, 0);
    OpenglCommon.checkNoGLES2Error("Attach texture to framebuffer");
  ...
  public void setSize(int width, int height) {
    ...
    GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, frameBufferId);
    OpenglCommon.checkNoGLES2Error("glBindFramebuffer");
  ...
  {
    if (frameBufferId != NO_FRAMEBUFFER)
    {
      GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, frameBufferId);
      GLES20.glViewport(0, 0, width, height);
    }
  }
  public void disactiveFrameBuffer()
  {
    GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
  }
